...
const RoastResults: React.FC<RoastResultsProps> = ({ 
  ...
  // Generate the shareble social media quote
          ...
          <CardContent className="space-y-6">
            ...
            {analysis && (
              <div className="space-y-4">
                ...
                {/* 
<div className="pt-4">
  <h4 className="font-medium text-gray-700 mb-2">Professional Feedback:</h4>
  <div className="text-gray-800 whitespace-pre-line p-4 bg-gray-50 border border-gray-200 rounded">
    {analysis.feedback}
  </div>
</div> 
*/}
          ...
          <CardFooter className="flex flex-col print:hidden">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-4">
              ...
              >
                ...
                {isGeneratingShareImage ? 'Generating...' : 'Generate Share Image'}
                {isGeneratingShareImage && <Loader2 className="h-4 w-4 animate-spin" />}
              </Button>
              ...
              >
                ...
                {isQuoteCopied ? 'Quote Copied!' : 'Copy Quote for Social Media'}
                {isQuoteCopied && <Check className="h-4 w-4 text-green-500" />}
              </Button>
            </div>
            
            {quoteText && (
              <div className="mb-4 p-3 bg-slate-50 rounded-md border border-slate-200">
                <p className="text-sm font-medium text-center text-slate-700 italic">
                  "{quoteText}"
                </p>
                <p className="text-xs text-center text-slate-500 mt-1">
                  ↑ Share this message with your image on social media
                </p>
              </div>
            )}
            
            <div className="text-center w-full text-xs text-gray-500">
              Generated by Roast My Resume on {new Date().toLocaleDateString()}
            </div>
          </CardFooter>
        </div>
      </Card>
